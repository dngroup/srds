...
python exp-replace-addr.py --tracker "$nuc6" --mpd "192.168.1.109" --content "192.168.1.109:8080" --opt1 192.168.1.104:8081 --opt2 192.168.1.107:8081 --opt3 192.168.1.118:8081 --opt5 192.168.1.110:8081 #--opt4 192.168.1.108:8081
