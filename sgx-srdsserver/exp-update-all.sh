...
python exp-replace-addr.py --tracker "$nuc6" --mpd "$nuc1" --content "$nuc1" #--opt1 192.168.1.104:8080 --opt2 192.168.1.107:8080 --opt3 192.168.1.118:8080 --opt5 192.168.1.110:8080 #--opt4 192.168.1.108:8080
