...
sleep 2
ssh -o ProxyCommand="ssh -W %h:%p pi@$raspi" -f nuc@"$nuc4" "~/srds/sgx-srdsserver/start-benchmark.sh $1 $2 $3 $4 &> ~/wrk2/logs/$1-$2-$3-$4.txt" # threads connections duration requests/s
