...
chromium-browser --headless --ignore-autoplay-restrictions --no-user-gesture-required --disable-default-apps --no-first-run http://localhost:8082/samples/dash-if-reference-player/index.html
